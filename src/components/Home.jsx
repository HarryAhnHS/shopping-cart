                ...
                <section className="flex gap-5 px-12">
                    <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
                        ...
                        <div className="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0">
                            <Link to="/shop" className="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-white rounded-lg bg-[#606c38] hover:opacity-80 focus:ring-4 focus:ring-red-300 dark:focus:ring-blue-900">
                                Shop now
                        ...
                        {featured.map((feat) => {
                                return (
                                    <div className="w-full sm:w-1/2 md:w-1/4 p-5" 
                                        key={feat.id}>
                                        <div className="flex rounded-xl bg-cover bg-center h-64 cursor-pointer hover:scale-105 transition-all duration-200"
